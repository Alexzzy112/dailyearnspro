...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="bg-white dark:bg-secondary-800 rounded-2xl p-8 card-shadow">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className={`p-4 rounded-xl ${item.accent ? 'gradient-primary text-white' : 'bg-gray-50 dark:bg-secondary-700'} text-center`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-6 rounded-xl card-shadow hover:shadow-lg transition bg-white dark:bg-secondary-800 group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white dark:bg-secondary-800 p-6 rounded-2xl card-shadow">
      ...
      {/* Contact Section */}
      <section className="py-16 bg-gray-50 dark:bg-secondary-800/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-white dark:bg-secondary-800 card-shadow">
