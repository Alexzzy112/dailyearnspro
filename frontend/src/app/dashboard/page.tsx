...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      <MotionDiv variants={fadeInUp(0.2)} initial="initial" animate="animate" className="mb-4 bg-white dark:bg-secondary-800 rounded-xl p-3 card-shadow overflow-hidden">
