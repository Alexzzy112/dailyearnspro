...
export default function DashboardPage() {
  ...
  const topWithdrawers = [
    { name: 'Tunde Balogun', amount: '350,000' },
    { name: 'Blessing Eze', amount: '280,000' },
    { name: 'Chioma Okonkwo', amount: '195,000' },
    { name: 'David Chukwu', amount: '420,000' },
    { name: 'Sarah Williams', amount: '310,000' },
  ];
      ...
      <Link href="/dashboard/top-members">
        <MotionDiv variants={fadeInUp(0.2)} initial="initial" animate="animate" className="mb-4 bg-white dark:bg-secondary-800 rounded-xl p-3 card-shadow overflow-hidden hover:shadow-md transition cursor-pointer">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Top Members Withdrawals</p>
          </div>
          <div className="overflow-hidden relative">
            <div className="flex gap-6 animate-marquee whitespace-nowrap" style={{ width: 'max-content' }}>
              {[...topWithdrawers, ...topWithdrawers, ...topWithdrawers].map((w, i) => (
